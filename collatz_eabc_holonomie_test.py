...
def run(limit: int = 10_000, output: Path = DEFAULT_OUTPUT) -> dict[str, Any]:
    ...
    report: dict[str, Any] = {
        "meta": {
            ...
            "correction": (
                "V₄ Klein → naive 𝔞≡0; Stufe 3–4: ω, χ_E (Orientierung/Chiralität); "
                "Stufe 5–6 offen (Transport T, Holonomie); ω(ABCE)=+1, ω(CEAB)=-1"
            ),
            "research_stage": {
                "1_klassifikation": "implemented",
                "2_signaturen": "implemented",
                "3_orientierung": "implemented",
                "4_chiralitaet": "implemented",
                "5_transport": "open",
                "6_holonomie": "open",
            },
        },
