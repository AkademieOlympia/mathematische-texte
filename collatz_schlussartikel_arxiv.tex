...
\]
wobei $E$ die Menge der 2-adischen Kontraktionszustände bezeichnet.
\end{vermutung}
...
[ Stationäres Maß pi ]
         |
         v
[ Negativer Drift Lambda ~ -0.830 ]  (heuristisch)
         |
         v
[ Klassenmischung |lambda_2| ~ 0.35 ]
         |
         v  <- Brücke fehlt
[ dist(n,E) >= c*2^{-log_2 n} ]  (Uniformitätsvermutung)
         |
         v
[ Volle Konvergenz ]
\end{verbatim}
