...
Q = QuaternionAlgebra(RR, -1, -1, names=("i", "j", "k"))
(i, j, k) = Q.gens()
...
# Extraktion des geschützten Kern-Speichers (e-Komponente = Basis 1)
c = N1_noisy.coefficient_tuple()
print(f"--> Ausgelesener e-Zentralwert (Speicher): {c[0]}")
spatial_noise_amp = sqrt(c[1]**2 + c[2]**2 + c[3]**2)
