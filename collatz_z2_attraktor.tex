...
\textbf{0~\texttt{sorry}} in der Datei; 18 bewiesene Lemmata/Theoreme.
...
\begin{itemize}[nosep]
  ...
  \item \texttt{ExceptionSetAccum} $=\bigcup_N E_{N,N}$;
    \texttt{ExceptionSet} $=\overline{\texttt{ExceptionSetAccum}}$ (entspricht Definition~\ref{def:E});
  \item \texttt{exitsExceptionApprox}, \texttt{inTrivialAttraktorApprox}: Austritt nach $K$ Schritten.
\end{itemize}
\end{tcolorbox}

\begin{tcolorbox}[heuristik,title={Noch offen}]
\begin{itemize}[nosep]
