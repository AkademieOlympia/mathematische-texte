...
\texttt{witness.py}).
\textbf{Kein Collatz-Anspruch}, \textbf{kein numerischer Zeuge} für die
Korrelation $\mathrm{corr}(I,\Pi)$ bis zur Auswertung von
\texttt{collatz\_praezession\_test.py}.
\end{abstract}
