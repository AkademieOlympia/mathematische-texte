...
**EABC-Begriffshierarchie (PR #54):** `collatz_eabc_holonomie.md` — sechs Stufen: (1) $\kappa(p)$, (2) Signaturen $\sigma(Q)$, (3) Orientierung $\omega$, (4) Chiralität $\chi_E$ (**implementiert**); (5) Transport $T:Q_k\to Q_{k+1}$, (6) Holonomie auf geschlossenen Pfaden (**offen**, Conjecture). Aktueller Status: **Orientierungsasymmetrie**, nicht wahre DG-Holonomie. Forschungsfrage: natürlicher Transportoperator zwischen EABC-Signaturen.
